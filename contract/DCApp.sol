...
contract DCApp {
    ...
    */
    ...
    function addNewDCAToUser(
        ...
        uint256 ownerFee = ((_totalOccurrences * _amountPerOccurrence * 100000) *
            500) / 10000000000;
        ...
        emit AddedNewDCA(timestamp, msg.sender, _totalOccurrences, _period, _amountPerOccurrence, _tokenIn, _tokenOut, _fee5Decimals);
        ...
        public
    {
        ...
        */
        ...
        if (msg.sender != _userAddress) {
            feeCaller =
                ((userDCA.amountPerOccurrence * 100000) * userDCA.fee5Decimals) /
                10000000000;
